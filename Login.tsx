...
const Login: React.FC<LoginProps> = ({ route, onLoginSuccess }) => {
  ...
  return (
    <Animated.View style={[styles.container, { opacity: fadeAnim, backgroundColor: '#f2f2f2' }]}>
...
const styles = StyleSheet.create({
  ...
  container: {
    ...
    maxWidth: isLargeScreen? 800:width,
    margin: isLargeScreen? 'auto':  0,
  },
  logo: {
    width: isLargeScreen ? 150:width * 0.25,  // Scale the logo based on screen width
    height: isLargeScreen ? 150:width * 0.25,
    marginBottom: isLargeScreen?-10:20,
  },
  title: {
    fontSize: isLargeScreen ? 60:width * 0.06,  // Responsive font size
    fontWeight: 'bold',
    color: '#4d9de0',
    marginBottom: isLargeScreen?0 :20,
  },
  subtitle: {
    fontSize: isLargeScreen ? 30: width* 0.04,
    color: '#7f8fa6',
    marginBottom: 30,
  },
  inputContainer: {
